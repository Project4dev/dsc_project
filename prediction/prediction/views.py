...
def predict_covid(request):
    ...
    if result == 0 :
        ...
        value = {'information':infected_information,'precaution':infected_precaution,'value':"Suffering from Covid ",'infected':1,'query':data}
        print('Infected')
...
def predict_breast_cancer(request):
    ...
    if result == 0 :
        value = {'info':info,'natural':natural,'exercise':exercise,'diet':diet,'value':"Breast Cancer Of Type Benign",'query':data}
        print('normal')
    else:
        
        value = {'info':info,'natural':natural,'exercise':exercise,'diet':diet,'value':"Brease Cancer Of Type Malignant",'query':data}
        print('Infected')
